...
export interface FinancialTransaction {
  id: string;
  date: string;
  type: 'encaissement' | 'transfert' | 'retrait' | 'versement' | 'dépense';
  description: string;
  amount: number;
...
export interface Truck {
  ...
  truckType: 'camion' | 'remorque' | 'allogaz';
}
...
export interface ReturnOrderItem {
  ...
  lostQuantity: number;
  soldQuantity: number;     // الآن تُملأ حسب: returnedEmptyQuantity + consigneQuantity
  consigneQuantity: number; // جديد: كمية القنينات المباعة مباشرة
}
